							                		...
							                		if (isset($subregistro->Participants)){
								                		foreach($subregistro->Participants as $eventParticipant){
															...
															if (empty($estadosEncontrados)) {
																// $sqlexistente = "SELECT * FROM leitores.tb_whatszap_call_log WHERE call_id = '".$prttcallID."' AND call_creator = '".$prttcallCreator."' AND call_type = '".$prttEtype."' AND call_timestamp = '".$prttEtimestamp."' AND call_from = '".$prttEsolicitante."' AND call_to = '".$prttEatendente."' AND call_from_ip = '".$prttEsolIP."' AND call_from_port = '".$prttEsolPort."' AND call_media_type = '".$prttEmediaType."' AND call_phone_number = '".$prttPhoneNumber."'";
